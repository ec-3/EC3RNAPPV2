...
async function runUploadAndroid() {
  ...
  const downloadLink = await uploadBuild('./app/build/outputs/apk/release/app-release.apk', `EC3APP-build-${packageInfo.build}-${refName}-${buildDateString}.apk`);
